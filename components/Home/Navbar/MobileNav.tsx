...
const MobileNav = ({showNav, closeNav}: Props ) => {
  ...
  return (
    <div>
      ...
      {/* navlinks */}
      <div className={`text-white ${navOpen} fixed  justify-center flex flex-col h-full transform transition-all duration-500 delay-100 w-[80%] sm:w-[70%] bg-emerald-500 space-y-10 z-[1050]`}>
      ...
      {navLinks.map((link) => {
         ...
         {/* contact us button */}
                    ...
                    <button className=" lg:block px-6 py-2 bg-emerald-500 text-white rounded-3xl  hover:bg-emerald-500">
                      Contact Us
